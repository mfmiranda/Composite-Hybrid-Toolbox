...
for dataset=1:100
filename=strcat(path3,'DataNull_LongTermNoise_',num2str(dataset));
load(filename)
...
FPArray(dataset,1)=Howmany/25600;
clearvars -except MSEArray FPArray  path3 path2 path Xt  Mac sep Phi_MatrixNew IndexPart AuxSize
end
save(strcat(path2,'ResultsSimNull100_CHSB_LongTerm'),'MSEArray','FPArray')
