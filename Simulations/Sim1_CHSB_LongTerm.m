...
load(strcat(path1,'Data_longterm_sim1'))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Create and save .hdr/.img images
...
%Generate signatures of signal locations
I0=double(I2.img);
save_nii(make_nii(I0),strcat(path1,'AtlasBackground'));
SignalContrastImage=zeros(size(I0));
SignalContrastImage(32:63,32:63,26:50)=abs(SignalContrast);
save_nii(make_nii(SignalContrastImage),strcat(path1,'SignalContrastImage'));
EstimatedMaskImage=zeros(size(I0));
EstimatedMaskImage(32:63,32:63,26:50)=SimbasMask;
save_nii(make_nii(EstimatedMaskImage),strcat(path1,'SimbasMaskImage'));
...
save(strcat(path1,"ResultsSim1_CHSB"),'IntervalWidth','RP','FP','MSE','totaltime')
...
extend=1;
[W,Kj]=Get_DWT(wavelet,111,boundary,1,6);
Wtrans=W';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Compute Correlations between ROI
%Compute index for each ROI
...
colormap('jet')
colorbar
saveas(gcf,strcat(path1,'ConnectivitySim1.png'))

subplot(2,2,1)
imagesc(CovarianceTime(1:100,1:100,1))
colorbar
title('Sim1 Cluster 1')
subplot(2,2,2)
imagesc(CovarianceTime(1:100,1:100,10))
colorbar
title('Sim1 Cluster 10')
subplot(2,2,3)
imagesc(CovarianceTime(1:100,1:100,4))
colorbar
title('Sim1 Cluster 4')
subplot(2,2,4)
imagesc(CovarianceTime(1:100,1:100,33))
colorbar
title('Sim1 Cluster 33')
